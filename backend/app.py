...
from routes import company_routes, agent_routes, project_routes, achievement_routes, difficulty_routes
...
def create_app(config: dict = None):
    ...
    app.register_blueprint(difficulty_routes.bp, url_prefix="/api/difficulty")
